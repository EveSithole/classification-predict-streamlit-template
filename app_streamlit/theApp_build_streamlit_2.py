...
def main():
    ...
    image = Image.open('resources/imgs/tweet_sent.jpg')

    st.image(image, caption='In the Twitterverse', use_column_width=True)

    st.subheader('Climate Change Beliefs Explored on twitter')
    

    ##creating a sidebar for selection purposes


    pages = ['Information', 'Visuals', 'Make Prediction']
    ...
    if selection == 'Information':
        ...
        st.write('Explorers get ready for the mission.......Explore the twittersphere')
        st.markdown(""" We have deployed Machine Learning models that are able to classify 
        whether or not a tweet is pro or anti climate change, based on their novel tweet data. 
        As intrepid data explorers, we have created custom solutions through our models, spanning multiple demographic and geographic categories. 
        Ready to dive into the app to understand more about sentiment on climate change, and how we all can work towards better outcomes for our climate.
